...
<TabItem label="Windows" icon="seti:windows">
  ...
  * **advanced options: *add to my PATH environment variable***  
    ...
    si par mégarde vous êtes allé jusqu'au bout sans cocher cette case, <LabeledLink label="label-troubleshoot-python-command-not-found" file="">voyez cette page</LabeledLink>
    </Admonition>
  </Admonition>
</TabItem>
