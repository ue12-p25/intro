...
vous trouverez <LabeledLink label="label-jupyter" file="">dans ce notebook</LabeledLink> plus de détails sur comment utiliser Jupyter
...
en vrai; <LabeledLink label="label-checklist" file="">vous la trouverez, ainsi qu'une liste de compétences, dans ce
