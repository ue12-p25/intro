...
import figSetPathGitForWindows from './assets/fig-set-path-git-for-windows.png';
import figMinicondaPowershellLocate from './assets/fig-miniconda-powershell-locate.png';
import figMinicondaPowershellMd from './assets/fig-miniconda-powershell-md.png';
import figMinicondaDownload from './assets/fig-miniconda-download.png';
import figMinicondaJustMe from './assets/fig-miniconda-just-me.png';
import figMinicondaSetInstallDir from './assets/fig-miniconda-set-install-dir.png';
import figMinicondaAddPath from './assets/fig-miniconda-add-path.png';
import figMacosAbout from './assets/fig-macos-about.png';
import sshKeygen from './assets/ssh-keygen.png';
import sshCopyKey from './assets/ssh-copy-key.png';
import githubProfile1 from './assets/github-profile-1.png';
import githubProfile2 from './assets/github-profile-2.png';
import jlabConfigDefer1 from './assets/jlab-config-defer-1.png';
import jlabConfigDefer2 from './assets/jlab-config-defer-2.png';
...
choisissez au moins l'option recommandée (#2) - on peut prendre l'option (#3) si on veut importer plus d'outils dans le terminal, mais ce n'est pas strictement nécessaire pour le cours
  ...
  <Image src={figSetPathGitForWindows} alt="Configuration du PATH dans Git for Windows" loading="lazy" />
  </Admonition>
...
<Admonition title="Windows" collapsible>
  ...
  1. pour lancer la console `PowerShell`
     ...
     <Image src={figMinicondaPowershellLocate} alt="Localisation de PowerShell" loading="lazy" />
  ...
  et pour cela il y a une seule ligne à taper
     ...
     <Image src={figMinicondaPowershellMd} alt="Création du dossier miniconda" loading="lazy" />
  ...
  <Image src={figMinicondaDownload} alt="Page de téléchargement de Miniconda" loading="lazy" />
  ...
  * ***Install for:*** (si la question vous est posée)   
    ...
    <Image src={figMinicondaJustMe} alt="Installation pour l'utilisateur courant" loading="lazy" />
  ...
  * **le choix du dossier où installer**  
    ...
    <Image src={figMinicondaSetInstallDir} alt="Choix du dossier d'installation" loading="lazy" />
  ...
  * **advanced options: *add to my PATH environment variable***  
    ...
    <Image src={figMinicondaAddPath} alt="Ajout au PATH" loading="lazy" />
...
<Admonition title="MacOS" collapsible>
  ...
  <Image src={figMacosAbout} alt="À propos de ce Mac" loading="lazy" />
  </Admonition>
...
1. <Admonition title="Ouvrez l'éditeur de *Settings*" collapsible>
   <Image src={jlabConfigDefer1} alt="JupyterLab Settings" loading="lazy" />
   </Admonition>
2. <Admonition title="Choisissez le mode `defer`" collapsible>
   ...
   <Image src={jlabConfigDefer2} alt="JupyterLab Settings" loading="lazy" />
    </Admonition>
</Steps>
...
ce programme va vous poser des questions, à ce stade je vous recommande de toujours **répondre par simplement la touche *Entrée***, pour accepter les défauts et ne pas attacher de mot de passe votre clé privée (ce qui n'est pas une pratique hyper-sûre, mais à ce stade de votre cursus ça parait raisonnable; si vous êtes geek et/ou très soucieux de sécurité, mettez un mot de passe mais soyez prêt à taper votre mot de passe *ad nauseam*, ou à passer du temps à des configurations scabreuses pour ne pas avoir à le faire...)
  ...
  <Image src={sshKeygen} alt="Génération de clé SSH" loading="lazy" />
  </Admonition>
</Admonition>
...
et vous copiez tout le contenu (en incluant bien tout, même le `ssh-rsa` et tout)
  ...
  <Image src={sshCopyKey} alt="Copie de la clé SSH" loading="lazy" />
  </Admonition>
</Admonition>
...
<Image src={githubProfile1} alt="Accès aux paramètres du profil GitHub" loading="lazy" />
...
<Image src={githubProfile2} alt="Ajout d'une clé SSH à GitHub" loading="lazy" />
