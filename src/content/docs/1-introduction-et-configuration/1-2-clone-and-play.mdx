...
import githubOrga from './assets/github-orga.png';
import githubChooseSsh from './assets/github-choose-ssh.png';
...
<Image src={githubOrga} alt="Organisation GitHub du cours" />
</Admonition>

Dans cette page, on va aller copier l'URL du cours; pour cela suivez les instructions ci-dessous.

<Image src={githubChooseSsh} alt="Choix de l'URL SSH pour cloner" loading="lazy" />
...
en vrai; [vous la trouverez, ainsi qu'une liste de compétences, dans ce
