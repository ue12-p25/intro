...
* et aussi on va pouvoir **passer des paramètres** aux programmes - <LabeledLink label="label-vscode-parameter" file="">voir par exemple avec vs-code</LabeledLink>
...
je suppose que vous l'avez déjà cloné, <LabeledLink label="label-clone-course" file="">sinon retournez à cette section pour le faire</LabeledLink>
