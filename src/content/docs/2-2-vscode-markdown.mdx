...
c'est pourquoi on lance *vs-code* en tapant `code .` - et ici le `.` signifie "le dossier courant", <LabeledLink label="label-bash-dot" file="">comme on l'a vu ici, rappelez-vous</LabeledLink>
</Admonition>
...
enfin pour bien utiliser vs-code avec git, <LabeledLink label="label-vscode-for-commit" file="">voyez cette section dans le notebook d'installation</LabeledLink>
</Admonition>
