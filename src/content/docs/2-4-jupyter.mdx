...
(enfin, si vous êtes bien  jour sur votre ordi, <LabeledLink label="label-git-pull" file="">voyez comment bien suivre les éventuelles modifications ultérieures</LabeledLink>)
