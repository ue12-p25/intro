...
<Image src={figBashRelativePaths} alt="Exemple de navigation dans les dossiers avec le terminal" />
</Admonition>
...
<Image src={figQuickAccessCoursInfo} alt="Raccourci vers le dossier cours-info dans l'explorateur Windows" />
...
<CardGrid>
  ...
  <Image src={figExplorerShowext1} alt="Explorateur Windows sans affichage des extensions" />
  </Card>
  <Card title="mais on peut le changer" icon="">
  <Image src={figExplorerShowext2} alt="Configuration de l'affichage des extensions dans l'explorateur Windows" />
  </Card>
</CardGrid>

si bien qu'après vous voyez bien ce qu'il faut: <Image src={figExplorerShowext3} alt="Explorateur Windows avec affichage des extensions" />
