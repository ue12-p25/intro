...
import figBashRelativePaths from './assets/fig-bash-relative-paths.png';
import figQuickAccessCoursInfo from './assets/fig-quick-access-cours-info.png';
import figExplorerShowext1 from './assets/fig-explorer-showext-1.png';
import figExplorerShowext2 from './assets/fig-explorer-showext-2.png';
import figExplorerShowext3 from './assets/fig-explorer-showext-3.png';
...
<Image src={figBashRelativePaths} alt="Exemple de navigation dans les dossiers avec le terminal" loading="lazy" />
</Admonition>
...
<Image src={figQuickAccessCoursInfo} alt="Raccourci vers le dossier cours-info dans l'explorateur Windows" loading="lazy" />
...
<CardGrid>
  ...
  <Image src={figExplorerShowext1} alt="Explorateur Windows sans affichage des extensions" loading="lazy" />
  </Card>
  <Card title="mais on peut le changer" icon="">
  <Image src={figExplorerShowext2} alt="Configuration de l'affichage des extensions dans l'explorateur Windows" loading="lazy" />
  </Card>
</CardGrid>

si bien qu'après vous voyez bien ce qu'il faut: <Image src={figExplorerShowext3} alt="Explorateur Windows avec affichage des extensions" loading="lazy" />
