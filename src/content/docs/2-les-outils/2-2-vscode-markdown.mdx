...
import figVscodeMarkdown from '@assets/fig-vscode-markdown.png';
...
* remarquer la petite icône <Image src={figVscodeMarkdown} alt="Icône Markdown dans VS Code" loading="lazy" />
