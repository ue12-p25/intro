...
<Image src={jlab003InDemo} alt="Explorateur de fichiers dans JupyterLab" loading="lazy" />

### créer un notebook

créez un nouveau notebook, et appelez-le `foo` (*File* -> *Rename Notebook...*), vous devez voir maintenant ceci

<Image src={jlab004NewNotebookFoo} alt="Nouveau notebook nommé 'foo'" loading="lazy" />
...
<Image src={jlab005MixedCells} alt="Notebook avec cellules mixtes (texte et code)" loading="lazy" />
...
remarquez la troisième icône <Image src={jlab006TocIcon} alt="Icône de table des matières" loading="lazy" />, qui permet d'afficher la table des matières

<Image src={jlab006MoreSpace} alt="Interface JupyterLab avec plus d'espace" loading="lazy" />
...
<CardGrid>
  <Card title="en mode 'commande'">
    ...
    <Image src={jlab007CommandMode} alt="Cellules en mode commande" loading="lazy" />
  </Card>
  <Card title="et en mode 'édition'">
    la différence est un peu subtile
    <Image src={jlab007EditMode} alt="Cellules en mode édition" loading="lazy" />
  </Card>
</CardGrid>
...
<Image src={jlab008Palette} alt="Palette de commandes dans JupyterLab" loading="lazy" />
...
<Image src={jlab009MultipleSelection} alt="Sélection multiple de cellules" loading="lazy" />
...
<Image src={jlab010MoveCells} alt="Animation montrant comment déplacer des cellules" loading="lazy" />
