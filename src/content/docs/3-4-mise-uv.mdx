...
description: setup alternatif à conda
---
...
la logique de mise consiste à pouvoir dire par exemple  
...
aussi, au dossier courant (il faudra bien penser à l'activer malgré tout)
...
- `venv` qui est utilisé en sous-main par `uv` pour les environnements virutels
